...
## フォームの宛先
push @mailto,'yamai@j-line.co.jp';
...
## 自動返信メールの差出人名
$config{'fromname'} = '【クラスアップ】エントリーありがとうございます';
...
## 設置者に届くメールの件名
$config{'subject'} = '【クラスアップ採用サイト】エントリーがありました';
...
■氏名：<_氏名_>
■氏名（ふりがな）：<_氏名（ふりがな）_>
■生年月日：<_年_>年 <_月_>月 <_日_>日
■性別：<_性別_>
■住所：郵便<_郵便番号_>　<_都道府県_>　<_市町村番地_>　<_マンション・ビル名_>
■電話番号：<_電話番号_>
■メールアドレス：<_email_>
■クラスアップに興味を持った理由：<_クラスアップに興味を持った理由_>
■卒業（予定）学校名：<_卒業（予定）学校名_>
■学部・学科名：<_学部・学科名_>
■卒業（予定）年：<_卒業（予定）年_>年
...
$config{"ReturnSubject"} = '【クラスアップ】エントリーありがとうございます';

## 自動返信メールの本文
$_TEXT{'responder'} = <<'__return_body__';

クラスアップ株式会社へのエントリーありがとうございます。
以下の内容でエントリーを受け付けました。
...
■生年月日：<_年_>年 <_月_>月 <_日_>日
■性別：<_性別_>
■住所：〒<_郵便番号_>　<_都道府県_>　<_市町村番地_>　<_マンション・ビル名_>
■電話番号：<_電話番号_>
■メールアドレス：<_email_>
■クラスアップに興味を持った理由：<_クラスアップに興味を持った理由_>
■卒業（予定）学校名：<_卒業（予定）学校名_>
